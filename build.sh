...
sed -i 's|--with-mail --with-mail_ssl_module --with-stream --with-stream_realip_module --with-stream_ssl_module --with-stream_ssl_preread_module|--with-http_v3_module --with-pcre-jit --without-select_module --without-poll_module --with-http_access_module --without-http_autoindex_module --without-http_browser_module --without-http_charset_module --without-http_empty_gif_module --with-http_limit_conn_module --with-http_memcached_module --without-http_mirror_module --without-http_referer_module --without-http_split_clients_module --without-http_scgi_module --without-http_ssi_module --with-http_upstream_hash_module --with-http_upstream_ip_hash_module --with-http_upstream_keepalive_module --with-http_upstream_least_conn_module --with-http_upstream_random_module --with-http_upstream_zone_module|g' rules
cd ..
